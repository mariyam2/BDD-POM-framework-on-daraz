...
Background:
 Given User Logins with 03328261288 and Abc123++
  ...
  Scenario: CASE:1b quantity to 5 for any phone model and moving to checkout page
  ...
  Scenario: Case 2: Add to cart all Samsung mobiles on first page with fast charging support
